import { Controller, Get, Post, Body, Patch, Param, Delete, HttpCode, NotFoundException, Req, Put } from '@nestjs/common';
...
export class UserTypeController {
  ...
  @Post()
  async create(@Body() body: CreateUserTypeDto, @Req() req: Request){
    try {
  ...
  @Put(':id')
  async update(@Param('id') id : string, @Body() body: UpdateUserTypeModDto, @Req() req: Request){
    try {
