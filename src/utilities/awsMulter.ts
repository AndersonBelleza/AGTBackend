...
// const { BUCKET_NAME, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, S3_ENDPOINT } = process.env;

// VAMAS ACTUAL
// const BUCKET_NAME = 'vlink'
// const AWS_ACCESS_KEY_ID = 'DO0022JZP49QWBD238RU'
// const AWS_SECRET_ACCESS_KEY = 'P8xCazteLwSB1FTjLn8XCfY2PVe+vy5BH8M9U170vX8'
// const S3_ENDPOINT = 'https://nyc3.digitaloceanspaces.com'
// const S3_PATH_FILE = `https://${BUCKET_NAME}.nyc3.digitaloceanspaces.com`

// VAMAS ANTIGUO

// const BUCKET_NAME = 'vamas'
// const AWS_ACCESS_KEY_ID = 'DO004YRJKGXKYQCHGDGF'
// const AWS_SECRET_ACCESS_KEY = 'ZmEeeXXelEgqCldfzRNmcaHGkE/XV7iYRjh2Z3MHidQ'
// const S3_ENDPOINT = 'https://sfo3.digitaloceanspaces.com'
// const S3_PATH_FILE = `https://${BUCKET_NAME}.sfo3.digitaloceanspaces.com`
...
export const base64ToFile = (base64: string, filename: string, extension:any): Express.Multer.File=>{
  try{
    const mime = extension; // Extraer MIME
    const buffer = Buffer.from(base64, 'base64'); // Crear Buffer

    // Retornar un objeto tipo Multer.File simulado
    if(buffer.length > 0){
      return {
        fieldname: filename,
      ...
      throw "Error al transformar el archivo"
    }

  }catch(error){
    console.log("error Base64ToFile",error);
    return error
  }
}